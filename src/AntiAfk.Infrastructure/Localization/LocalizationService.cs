...
public sealed class LocalizationService
{
    ...
    public LocalizationService()
    {
        Load("ru", """
        {
          ...
          "notify.engine_gave_up": "Движок остановлен: слишком много сбоев подряд. Подробности в консоли логов.",
          "notify.already_running": "AntiAFK уже запущен.",
          "notify.project_chosen": "Выбран проект: {project}. Чтобы запомнить выбор, сохраните настройки во вкладке Настройки.",
          "project.choose": "Выберите проект:",
        ...
        Load("en", """
        {
          ...
          "notify.engine_gave_up": "Engine stopped: too many crashes in a row. See the log console for details.",
          "notify.already_running": "AntiAFK is already running.",
          "notify.project_chosen": "Project chosen: {project}. To remember this choice, save your settings in Settings.",
